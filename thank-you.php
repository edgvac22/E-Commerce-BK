  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Gracias por su pedido</h1>
        <p class="lead text-muted">Actualmente esta pasando por la logística de nuestra empresa, una vez su comida este lista, le estaremos avisando vía correo electrónico.</p>
        <p>
          <a href="mi-cuenta.php" class="btn btn-primary my-2">Ver estatus del pedido</a>
          <a href="productos.php" class="btn btn-secondary my-2">Seguir Comprando</a>
        </p>
      </div>
    </div>
  </section>
